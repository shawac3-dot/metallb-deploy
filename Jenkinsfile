pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/shawac3-dot/metallb-deploy.git'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('shawac3-225')   // <---- Change this to match your kubernetes cluster credentials
    }
